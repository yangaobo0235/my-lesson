...
export const GATEWAY_HOST = import.meta.env.VITE_GATEWAY_URL
    ?? (import.meta.env.PROD ? '' : `${HOST}:24101`);
...
export const PROJECT_SKILLS = [
    ...
    {label: 'AI 运行时', value: 'Python + FastAPI', version: '3.12'},
    {label: '微服务', value: 'Spring Cloud Alibaba', version: '2023.0.1.0'},
    {label: 'AI 应用', value: 'OpenAI-compatible SDK', version: '2.x'},
    {label: 'Agent', value: 'LangGraph', version: '1.x'},
